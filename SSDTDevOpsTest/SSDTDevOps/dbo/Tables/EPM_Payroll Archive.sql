CREATE TABLE [dbo].[EPM$Payroll Archive] (
    ...
    [P46 Printed]                 TINYINT          NOT NULL,
    [P45 Part3 Printed]           TINYINT          NOT NULL,
    ...
    CONSTRAINT [EPM$Payroll Archive$0] PRIMARY KEY CLUSTERED ([No_] ASC) WITH (FILLFACTOR = 99)
);
